...
/*!*******************************************************************************!*\
  !*** ./node_modules/angular-ng-autocomplete/fesm5/angular-ng-autocomplete.js ***!
  \*******************************************************************************/
/*! exports provided: AutocompleteLibService, AutocompleteLibComponent, AutocompleteLibModule, AutocompleteComponent, HighlightPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AutocompleteLibService", function() { return AutocompleteLibService; });
...
var AutocompleteLibService = /** @class */ (function () {
    ...
    /** @nocollapse */ AutocompleteLibService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["defineInjectable"])({ factory: function AutocompleteLibService_Factory() { return new AutocompleteLibService(); }, token: AutocompleteLibService, providedIn: "root" });
...
var AutocompleteComponent = /** @class */ (function () {
     ...
     */
    function () {
        this.inputKeyUp$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(this.searchInput.nativeElement, 'keyup').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (e) { return e; }));
        this.inputKeyDown$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(this.searchInput.nativeElement, 'keydown').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (e) { return e; }));
    ...
    function () {
        ...
        this.inputKeyUp$
            ...
            return !isArrowUpDown(e.keyCode) &&
                ...
                !isESC(e.keyCode) &&
                !isTab(e.keyCode);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(this.debounceTime)).subscribe(function (e) {
            _this.onKeyUp(e);
        });
        // cursor up & down
        this.inputKeyDown$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (e) { return isArrowUpDown(e.keyCode); })).subscribe(function (e) {
            e.preventDefault();
            _this.onFocusItem(e);
        });
        // enter keyup
        this.inputKeyUp$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (e) { return isEnter(e.keyCode); })).subscribe(function (e) {
            //this.onHandleEnter();
        });
        // enter keydown
        this.inputKeyDown$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (e) { return isEnter(e.keyCode); })).subscribe(function (e) {
            _this.onHandleEnter();
        });
        // ESC
        this.inputKeyUp$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (e) { return isESC(e.keyCode); }, Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(100))).subscribe(function (e) {
            _this.onEsc();
        });
        // delete
        this.inputKeyDown$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (e) { return isBackspace(e.keyCode) || isDelete(e.keyCode); })).subscribe(function (e) {
            _this.onDelete();
        });
    };
    /**
    ...
    AutocompleteComponent.propDecorators = {
        ...
        itemTemplate: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ContentChild"], args: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"],] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
...
module.exports = "<ion-header>\n  <ion-toolbar color=\"primary\">\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>\n    <ion-title>Member Contact Directory</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content> \n  <!-- <ion-searchbar showCancelButton cancelButtonText=\"Custom Cancel\" (ionInput)=\"getItems($event)\" ></ion-searchbar>\n  <ion-list *ngIf=\"showList\">\n    <ion-item *ngFor=\"let item of items\">\n      {{ item }}\n    </ion-item>\n  </ion-list> -->\n  <ion-grid style=\"padding:10px\">\n    <ion-row>\n      <ion-label style=\"margin-bottom: 10px\">\n       Search Member\n      </ion-label>\n      <br>\n      <div class=\"ng-autocomplete\">\n        <ng-autocomplete \n          [data]=\"data\"\n          [searchKeyword]=\"keyword\"\n          (selected)='selectEvent($event)'\n          (inputChanged)='onChangeSearch($event)'\n          (inputFocused)='onFocused($event)'\n          [itemTemplate]=\"itemTemplate\"\n          [notFoundTemplate]=\"notFoundTemplate\"\n          placeHolder=\"Member Name\"> </ng-autocomplete>\n         \n        <ng-template #itemTemplate let-item>\n        <a [innerHTML]=\"item.name\"></a>\n        </ng-template>\n         \n        <ng-template #notFoundTemplate let-notFound>\n        <div [innerHTML]=\"notFound\"></div>\n        </ng-template>\n        </div>\n    </ion-row>\n  </ion-grid>\n  \n</ion-content>\n"
...
module.exports = ".searchbar-input.sc-ion-searchbar-md {\n  box-shadow: none !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SearchPage = /** @class */ (function () {
    function SearchPage(authsrv, router, loadingController) {
    ...
    SearchPage.prototype.myapi = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        this.authsrv.getallapprove().subscribe(function (data) {
                            _this.arr = data;
                            _this.arr.forEach(function (item) {
                                _this.data.push({ id: item.id, name: item.name });
    ...
    SearchPage.prototype.selectEvent = function (item) {
        var id = item.id;
        console.log(id);
        console.log(item);
        this.router.navigate(['/single-member/' + id]);
    };
    SearchPage.prototype.onChangeSearch = function (val) {
        // fetch remote data from here
        // And reassign the 'data' which is binded to 'data' property.
    };
    SearchPage.prototype.onFocused = function (e) {
    ...
    SearchPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["LoadingController"]])
    ], SearchPage);
    return SearchPage;
}());
